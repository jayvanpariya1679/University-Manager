...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/University.jpg"));
        Image i3 = ic.getImage().getScaledInstance(2000, 1000,Image.SCALE_DEFAULT);
        ...
        master.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        ...
        m2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        user.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        JMenuItem u1 = new JMenuItem("Student Details");
        JMenuItem u2 = new JMenuItem("Teacher Details");
        user.setForeground(Color.RED);
        
        u1.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        u2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        attendance.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        ...
        a1.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        a2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        attendance_detail.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        ...
        exam.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        JMenuItem c1 = new JMenuItem("Examination Details");
        JMenuItem c2 = new JMenuItem("Enter Marks");
        exam.setForeground(Color.BLUE);
        
        c1.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        c2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        report.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        JMenuItem r1 = new JMenuItem("Update Students");
        JMenuItem r2 = new JMenuItem("Update Teachers");
        report.setForeground(Color.RED);
        
        r1.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        r2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        fee.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        JMenuItem s1 = new JMenuItem("Fee Structure");
        JMenuItem s2 = new JMenuItem("");
        fee.setForeground(Color.BLUE);
        
        s1.setFont(new Font("TimesNewRoman",Font.BOLD,16));
...
//        s2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
...
//        s2.addActionListener(this);
        ...
        utility.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        ...
        ut1.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        ut2.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        ut3.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        about.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        JMenuItem aboutus = new JMenuItem("About Us");
        about.setForeground(Color.BLUE);
        
        aboutus.setFont(new Font("TimesNewRoman",Font.BOLD,16));
        ...
        exit.setFont(new Font("TimesNewRoman",Font.TRUETYPE_FONT,20));
        JMenuItem ex = new JMenuItem("Exit");
        exit.setForeground(Color.RED);
        

        ex.setFont(new Font("TimesNewRoman",Font.BOLD,16));
