...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Department","Class XII(%)","Phone No","Email","Class X(%)","Address","Aadhar No","Roll No","Branch"};
    ...
    StudentDetails(){
        ...
        l1 = new JLabel("Enter Aadhar number to delete Student : ");
